package com.lovewuchin.game.twozerogame;
...
import android.view.*;
import com.lovewuchin.game.twozerogame.setting.SettingPreference;
...
public class MainActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.setting : startActivity(new Intent(this , SettingPreference.class));
        }
        return true;
    }
